...
extension SnowflakeEntityExtensions<T extends SnowflakeEntity<T>> on SnowflakeEntity<T> {
...
extension ManagedSnowflakeEntityExtensions<T extends ManagedSnowflakeEntity<T>> on ManagedSnowflakeEntity<T> {
